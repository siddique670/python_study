...
# y = base64
# z = std_out
# output = literal_eval(base64.b64decode(std_out))
...
# encoded_parameters = {"name":"CPU","Password":"Sunday@123","UserName": "429233","HostName":"EC2AMAZ-3P1CRD5","SelectedDeviceStatus":"Usage","impersonate_user":"429233","impersonate_password":"Sunday@123"}
# print(encoded_parameters)

# output = "Failed to connect jump host to execute the action.ERROR: "+str
# print(output)
